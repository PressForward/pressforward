...
class PFOpenGraph implements Iterator
{
     ...
     */
      ...
      if ( function_exists('curl_version') || empty($response) || is_wp_error($response) || ( !empty($response) && !empty($response['headers']) && isset($response['headers']['content-length']) && ( 50 > strlen($response['headers']['content-length']) ) ) ){
