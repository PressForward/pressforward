...
use GenderEngine\Matchers\ListWeightedMatch as ListWeightedMatch;

class ListWeightedMatchTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->listMatcher = new ListWeightedMatch();
    }
    ...
    public function testFoundMaleAndFemaleName()
    {
        ...
        $this->assertEquals('FEMALE', $this->listMatcher->test('ashley'));
    }
