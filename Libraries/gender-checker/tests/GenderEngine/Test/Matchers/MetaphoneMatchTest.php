...
use GenderEngine\Matchers\MetaphoneMatch as MetaphoneMatch;

class MetaphoneMatchTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->listMatcher = new MetaphoneMatch();
    }
    ...
    public function testFoundMaleAndFemaleName()
    {
        ...
        $this->assertEquals('UNKNOWN', $this->listMatcher->test('ashlie'));
    }
