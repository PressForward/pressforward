...
class Metas implements HasFilters, HasActions {
	...
	public function structure() {
		...
		$metas = array(
			...
			'source_publisher_name'   => [
				'name'       => 'source_publisher_name',
				'title'      => __( 'Publisher Name', 'pressforward' ),
				'definition' => __( 'Name of the publisher', 'pressforward' ),
				'function'   => __( 'Stores the name of the publisher of the item', 'pressforward' ),
				'type'       => [ 'struc' ],
				'use'        => [ 'api' ],
			...
			'source_publisher_url'    => [
				'name'       => 'source_publisher_url',
				'title'      => __( 'Publisher URL', 'pressforward' ),
				'definition' => __( 'URL of the publisher', 'pressforward' ),
				'function'   => __( 'Stores the URL of the publisher of the item', 'pressforward' ),
				'type'       => [ 'struc' ],
				'use'        => [ 'api' ],
				'level'      => [ 'item', 'nomination', 'post' ],
				'serialize'  => false,
