...
function authorsSet() {
	...
	switch (action.type) {
		...
		case 'FILL_AUTHORS':
			var added = false;
			var newState = state.map(function (author) {
...
var statsApp = (0, _redux.combineReducers)({
...
var store = (0, _redux.createStore)(_reducers2.default, startingStore, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
var _AuthorCard = __webpack_require__(32);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function render(a, b, c, d) {
            ...
            (0, _preact.h)(
                'div',
                { id: 'pf-stats__author-leaderboard' },
                (0, _preact.h)(
                    'ul',
                    null,
                    authorsSet.map(function (author) {
                        return (0, _preact.h)(_AuthorCard2.default, {
                            key: author.id,
...
//let authorsSet = {};
var fillAuthors = exports.fillAuthors = function fillAuthors(key, object) {
	return {
		type: 'FILL_AUTHORS',
		id: key,
		author: object
...
var pageCheck = exports.pageCheck = function pageCheck(pageNumber) {
	return {
		type: 'SET_PAGE',
		page: pageNumber
	};
...
var AuthorCard = function (_Component) {
    _inherits(AuthorCard, _Component);

    function AuthorCard() {
        _classCallCheck(this, AuthorCard);

        return _possibleConstructorReturn(this, (AuthorCard.__proto__ || Object.getPrototypeOf(AuthorCard)).apply(this, arguments));
    }
    ...
    _createClass(AuthorCard, [{
        ...
        value: function render(_ref) {
            ...
            (0, _preact.h)(
                ...
                (0, _preact.h)(
                    "div",
                    { id: "{key}", "class": "pf-stats__author-card" },
                    (0, _preact.h)(
                        "ul",
                        null,
                        (0, _preact.h)(
