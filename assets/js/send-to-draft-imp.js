jQuery( window ).load(function() {
	jQuery( '.pf_container' ).on('click', ".nom-to-draft", function (evt){
		...
		var nom_id			= jQuery( "#nom_id_" + itemID ).val(); 		var nom_date 		= jQuery( "#date_nominated_" + itemID ).val(); 		var nom_tags		= jQuery( "#nom_tags_" + itemID ).val(); 		var nom_count		= jQuery( "#nominators_" + itemID ).val(); 		var nom_users		= jQuery( "#submitters_" + itemID ).val(); 		var nom_content 	= jQuery( "#item_content_" + itemID ).val();
