...
<p>
	<?php
		esc_html_e( 'The following options are advanced tools for admins attempting to test, debug, or execute advanced functionality. They are capable of breaking your retrieval process.', 'pf' );
	?>
</p>
...
<p>
	<button type="submit" class="refreshfeed btn btn-small" id="refreshfeed" value="<?php esc_attr_e( 'Refresh', 'pf' ); ?>"><?php esc_html_e( 'Refresh', 'pf' ); ?></button>
	<?php
...
<p>
	<button type="submit" class="cleanfeeds btn btn-small" id="cleanfeeds" value="<?php esc_attr_e( 'Clean Up', 'pf' ); ?>"><?php esc_html_e( 'Clean Up', 'pf' ); ?></button>
	<?php
