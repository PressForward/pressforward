		...
		<p>
			...
			<?php
				_e( ' the feed items. You can press this button this button to manually initiate the process of selecting feed items more than 2 months old. There is a chance of initiating this process simultaneously with a process triggered automatically every 30 minutes. If this occurs, error messages will likely appear in your server logs.', 'pf');
			?>
		</p>
		<?php
		do_action('pf_tools');
