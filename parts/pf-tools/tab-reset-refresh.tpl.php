...
<p>
	<button type="submit" class="cleanfeeds button button-secondary" id="cleanfeeds" data-pf-disassemble-nonce="<?php echo esc_attr( wp_create_nonce( 'pf_ajax_disassemble_item' ) ); ?>" value="<?php esc_attr_e( 'Clean Up', 'pressforward' ); ?>"><?php esc_html_e( 'Clean Up', 'pressforward' ); ?></button>
</p>
