...
<p>
	<?php esc_html_e( 'Users can control aspects of the content display in the Feed Items and Nominated pages by setting preferences here.', 'pressforward' ); ?>
</p>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<fieldset>
					...
					<p class="description">
						<?php esc_html_e( 'When this box is checked, a menu that includes a list of feeds with alerts displays on the right side of the Feed Items and Nominated pages.', 'pressforward' ); ?>
					</p>
				</fieldset>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<p class="description">
					<?php esc_html_e( 'Setting this number determines how many items will appear on the Feed Items and Nominated pages when infinite scroll is turned off.', 'pressforward' ); ?>
				</p>
			</td>
		</tr>
