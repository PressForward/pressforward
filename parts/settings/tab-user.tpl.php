...
<p>
	...
	?> <br /><?php esc_html_e( 'When this box is checked, users can scroll through content continuously.', 'pf' ); ?>
</p>
<hr />
<p>
	<?php
	...
	?> <br /><?php esc_html_e( 'When this box is checked, a menu that includes a list of feeds with alerts displays on the right side of the All Content and Nominated pages.', 'pf' ); ?>
</p>
<hr />
<p>
	<?php
	...
	?> <br /><?php esc_html_e( 'Setting this number determines how many items will appear on the All Content and Nominated pages when infinite scroll is turned off.', 'pf' ); ?>
</p>
