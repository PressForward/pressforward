...
<p>
	...
	<label class="description" for="pf_metrics_config[basic]"><?php esc_html_e( 'Opt-in to allow us to collect non-sensitive diagnostic information for plugin improvement.', 'pf' ); ?></label>
	<!--
	...
	<label class="description" for="pf_metrics_config[detailed]"><?php esc_html_e( 'Allow detailed tracking', 'pf' ); ?></label>
	-->
</p>
<hr />
<p>
